    ...
    <div class="container py-5 mt-5">
        ...
        <div class="profile-header p-4 mb-4 text-center">
            <div class="d-flex flex-column align-items-center">
                <img src="{{ asset('storage/public/Students/'.$user->image) }}" alt="Profile" style="height: 100% ; width:200px" class="profile-img rounded-circle mb-3">
                <h2 class="mb-1">{{$user->name}}</h2>
                <p class="mb-2"><i class="fas fa-graduation-cap me-2"></i>{{ucfirst($user->role)}}</p>
                <p class="mb-3"><i class="fas fa-university me-2"></i><b>{{$user->student->status}}<b></p>
            ...
            <div class="col-lg-4">
                ...
                <div class="card stats-card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Passionate computer science student with focus on web development and machine learning. Currently in my final year with a 3.8 GPA.</p>
                        <hr>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted">{{$user->student->id}}</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="course-meta mb-3">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-dark fw-medium">{{ $course->pivot->course_location }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-dark fw-medium">{{ $course->pivot->created_at->format('Y-m-d ,D')}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress-container mt-4">
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <small class="text-primary fw-bold">{{ $course->pivot->course_status }}</small>
                                            </div>
