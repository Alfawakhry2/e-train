            ...
            <div class="flex flex-col items-center">
                ...
                @if (isset($course->image))
                    <div class="mb-4 text-center">
                        ...
                        <div class="relative">
                            <img src="{{ asset('storage/' . $user->image) }}" alt="Current Course Image"
                            ...
                            <div
                                ...
                                <span class="text-white text-sm bg-black bg-opacity-50 px-2 py-1 rounded">Current
                                    Image</span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="imagePreviewContainer" class="hidden mb-4 text-center">
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-blue-500 bg-opacity-20 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity rounded-lg">
