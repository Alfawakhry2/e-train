            ...
            <tr>
                ...
                <td class="py-3 px-4">
                    <div class="d-flex flex-column">
                        <!-- Show button (bigger) -->
                        <div class="mb-2">
                            <a href="{{ url("admin/show/member/$user->id") }}" class="btn btn-dark btn-sm w-100 fs-3">Show</a>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            {{-- Delete Form --}}
                            <form action="{{route("DeleteMember" , $user->id )}}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user ?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-outline-danger btn-sm w-45 fs-3">Delete</button>
                            </form>
