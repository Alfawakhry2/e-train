...
<head>
  ...
  <script>
    ...
    var pusher = new Pusher('1c2b75e983b43dcd1b2e', {
      cluster: 'eu'
    });
    ...
    channel.bind('my-event', function(data) {
        // console.log(data)    
      document.getElementById('not').innerHTML=data;
    });
  </script>
    {{--end pusher --}}
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/allstudents') }}" class="">
                                                <div class="text">Show Students</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/alltrainers') }}" class="">
                                                <div class="text">Show Trainer</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/AddMember') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <div class="text">Category Of Courses</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/add/category') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/add/course') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <div class="text">Trashed</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/all/trashed/members') }}" class="">
                                                <div class="text">Members</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ url('admin/all/trashed/categories') }}" class="">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <div class="message-item item-2">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">new notification</div>
                                                        <div class="text-tiny" id="not"></div>
                                                    </div>
                                                </div>
                                            </li>
