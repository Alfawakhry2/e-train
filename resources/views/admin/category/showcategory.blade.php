...
<div class="container py-4 fs-3">
    <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
        ...
        <div class="card bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center m-5  p-0">
                <h2 class="mb-0 fw-bold text-light">
                    <i class="bi bi-tag-fill me-3"></i>{{ $category->title }}
                </h2>
                <div>
                    <a href="{{ url('admin/allcategories') }}" class="btn btn-lg btn-outline-light mx-5">
                        <i class="me-2 fs-3"></i> Back
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-5">
            ...
            <div class="mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-bold d-block mb-3">Slug</label>
                        <div class="p-3 bg-light rounded-3 border-bottom border-3 border-primary">
                            {{ $category->slug ?? 'N/A' }}
                        </div>
                    </div>
        ...
        <div class="card-footer bg-light py-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url("admin/edit/category/$category->id") }}" class="btn btn-primary btn-lg fs-3"> Update Category </a>
                <form action="{{ route('DeleteCategory' , $category->id) }}" method="POST"
                      onsubmit="return confirm('Are you sure you want to delete this category?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger btn-lg px-4 fs-3">
