...
<div class="container mt-5">
    @include('success')
    <h3 class="text-danger text-center">Deleted Categories</h3>
    <div class="row">
            ...
            <div class="card bg-light text-dark h-100 shadow-sm border-0">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mt-4 d-flex flex-column gap-2">
                        <a href="{{ url("admin/restore/category/$category->id") }}" class="btn btn-outline-success fs-4">Restore Category</a>
                        <form action="{{ route('PDeleteCategory' , $category->id) }}" method="POST"
                            onsubmit="return confirm('Are you sure you want to delete this category For ever?');">
                          @csrf
                          @method('DELETE')
                          <button type="submit" class="btn btn-lg btn-outline-danger fs-4 w-100">
                            Permenent Delete Category
                          </button>
                      </form>
                    </div>
                </div>
