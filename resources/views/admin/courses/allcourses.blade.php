      ...
      <div class="col">
        <div class="card h-100 shadow-sm border-0">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title">{{$course->title}}</h5> <strong class="fs-3 text-success">$ {{$course->price}}</strong>
          ...
          <div class="card-footer bg-white border-top-0">
            ...
            <span class="fs-3">Start Date : {{$course->start_date}}</span>
              ...
              <a href="{{ url("admin/show/course/$course->id") }}" class="btn btn-sm btn-outline-primary fs-3">View Course</a>
            </div>
          </div>
        </div>
      </div>
